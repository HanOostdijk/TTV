...
test_that("create_html_table okay", {
  ...
  st5 <- fx(create_html_table(df1,class="aap-noot", tstyle="border-collapse:collapse;border:none;"))
  ...
  res6 <- "<div>\n <tabl>\n  <tr><td>1</td><td>A</td></tr>\n  <tr><td>2</td><td>B</td></tr>\n </table>\n</div>"
  expect_equal(st5,res5)
  st7 <- fx( create_html_table(df1,class="fit-tablex",html_include=fit_table_def))
